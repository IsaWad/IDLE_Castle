class Castle:
    ...
    def tax(self):
        ...
        excluded_attributes = ['weather', 'farmLVL']  # Attributes to exclude
        total_tax = 0
    ...
    def upgrade_building(self, building_name):
        ...
        if hasattr(self, building_name + 'LVL'):
...
class JapaneseCastle(Castle):
    def __init__(self):
        super().__init__()
        self.region = "Japan"
        self.dojoLVL = 1  # Additional attribute specific to Japanese castles
